...
GetClassHoursResponse sectionViewResponseFromJson(String str) => GetClassHoursResponse.fromJson(json.decode(str));

String sectionViewResponseToJson(GetClassHoursResponse data) => json.encode(data.toJson());
...
class GetClassHoursResponse {
    ...
    factory GetClassHoursResponse.fromJson(Map<String, dynamic> json) => GetClassHoursResponse(
        classes: json["classes"] == null ? [] : List<ClassElement>.from(json["classes"]!.map((x) => ClassElement.fromJson(x))),
