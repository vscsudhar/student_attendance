...
mixin NavigationMixin {
  ...
  void goToStudentConfirmation(List<GetStudentResponse> absentList, List<GetStudentResponse> presentList, int cid, int hid,int subjectId) => _navigationService.navigateTo(Routes.studentConfirmationView, arguments: StudentConfirmationViewArguments(absentStudentList: absentList, presentStudentList: presentList, cid: cid, hid: hid,subjectId: subjectId));
