...
abstract class StudentConfirmationView extends StackedView<StudentConfirmationViewModel> {
  ...
  Widget build(BuildContext context) => ViewModelBuilder.reactive(
        viewModelBuilder: () => StudentConfirmationViewModel(cid,hid),
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            'Absented students = ${absentStudentList.length}',
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            'Presented students = ${presentStudentList.length}',
